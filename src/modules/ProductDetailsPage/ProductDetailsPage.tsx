...
export const ProductDetailsPage = () => {
  ...
  const handleAddToFavorite = (e: React.MouseEvent, product: ProductData) => {
    ...
    addToFavorites(normalizeProduct(product));
  };
      ...
      <div className={styles.productGrid}>
        ...
        <div className={styles.infoSection}>
          ...
          <div className={styles.actions}>
            <button
              className={`${styles.addBtn} ${isInCart(cartId) ? styles.inCart : ''}`}
              onClick={e => handleAddToCart(e, productData)}
            >
              {isInCart(cartId) ? 'Added' : 'Add to cart'}
            </button>
            <button
              className={`${styles.favBtn} ${isFavorite(favId) ? styles.isFav : ''}`}
              onClick={e => handleAddToFavorite(e, productData)}
            >
              <img src={isFavorite(favId) ? like : HeartIcon} alt="favorite" />
            </button>
          </div>
